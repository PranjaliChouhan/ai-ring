      ...
      Back to Home
        ...
        <div className="pt-8">
          <div className="border border-emerald-400/30 rounded-lg p-6 bg-emerald-400/5">
            <div className="space-y-2">
              <p className="text-sm font-medium text-emerald-400">Order Details</p>
              <p className="text-sm text-gray-400">A confirmation email has been sent to your email address.</p>
            </div>
          </div>
        </div>
      </div>
